// Report 50055 "Sales - Invoice11"
// {
//     Caption = 'Sales - Invoice';
//     Permissions = TableData "Sales Shipment Buffer" = rimd;
//     RDLCLayout = './Layouts/Sales-Invoice11.rdlc';
//     DefaultLayout = RDLC;
...
//             {
//             }
//             column(BankAccount_BankAccount_No; BankAccount."Bank Account No.")
//             {
//             }
...
//             {
//             }
//             column(CustomerPo; "Sales Invoice Header"."External Document No.")
//             {
//             }
//             column(Stte_Description; Stte.Description)
//             {
//             }
...
//                     {
//                     }
//                     column(CompanyInfoVATRegNo; ShippingLocation."T.I.N. No.")
//                     {
//                     }
...
//                             AutoFormatType = 1;
//                         }
//                         column(Description_SalesInvLine; DescriptiontoPrint)
//                         {
//                         }
...
//                         {
//                         }
//                         column(ChargeToCustomer; "Sales Invoice Line"."Charges To Customer")
//                         {
//                         }
...
//                             AutoFormatType = 1;
//                         }
//                         column(AmtInclVAT_SalesInvLine; Amount_To_Customer)
//                         {
//                             AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
//                             AutoFormatType = 1;
//                         }
...
//                             AutoFormatType = 1;
//                         }
//                         column(TaxAmount_SalesInvLine; TotalGstAmt_)
//                         {
//                             AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
//                             AutoFormatType = 1;
//                         }
...
//                         {
//                         }
//                         column(TaxAmountCaption; StrSubstNo(TaxAmountCaptionLbl, TaxType))
//                         {
//                         }
...
//                             Amount_To_Customer := CustLedEntry.amount;
...
//                             Clear(SGSTAmount);
//                             Clear(GstAmount);
//                             DetailGSTLedEntry.Reset();
//                             DetailGSTLedEntry.SetRange("Document No.", "Sales Invoice Line"."Document No.");
//                             DetailGSTLedEntry.SetRange("Document Line No.", "Sales Invoice Line"."Line No.");
//                             DetailGSTLedEntry.SetRange("Transaction Type", DetailGSTLedEntry."Transaction Type"::Sales);
//                             DetailGSTLedEntry.CALCSUMS(DetailGSTLedEntry."GST Amount");
//                             if DetailGSTLedEntry.FindFirst then begin
//                                 repeat
//                                     if DetailGSTLedEntry."GST Component Code" = 'CGST' then begin
//                                         CGSTAmount := Abs(DetailGSTLedEntry."GST Amount");
//                                         // CGSTPer := DLE."GST %";
//                                         GstAmount := DetailGSTLedEntry."GST Base Amount";
//                                     end;
//                                     if DetailGSTLedEntry."GST Component Code" = 'SGST' then begin
//                                         SGSTAmount := Abs(DetailGSTLedEntry."GST Amount");
//                                         // SGSTPer := DLE."GST %";
//                                         GstAmount := DetailGSTLedEntry."GST Base Amount";
//                                     end;
//                                     if DetailGSTLedEntry."GST Component Code" = 'IGST' then begin
//                                         IGSTAmount := Abs(DetailGSTLedEntry."GST Amount");
//                                         // IGSTPer := DLE."GST %";
//                                         GstAmount := DetailGSTLedEntry."GST Base Amount";
//                                     end;
//                                     TotalGstAmt_ := IGSTAmount + CGSTAmount + SGSTAmount
//                                 until DetailGSTLedEntry.Next = 0;
//                             end;
...
//                             //IN0090.begin
//                             TotalAmountInclVAT += Amount_To_Customer;
...
//                             //             TotalTaxAmt += Abs(StructureLineDetails.Amount);
//                             //             /*
...
//                             end;
//                             RowIdText := ItemTrackingMgt.ComposeRowID(Database::"Sales Invoice Line",
//                                 0, "Document No.", '', 0, "Line No.");
//                             Clear(TempItemLedgerEntry);
//                             DescriptiontoPrint := '';
//                             Serials := '';
//                             TempItemLedgerEntry.Reset;
//                             ItemTrackingMgt.RetrieveILEFromPostedInv(TempItemLedgerEntry, RowIdText);
//                             TempItemLedgerEntry.SetRange(TempItemLedgerEntry."Document Line No.", "Line No.");
//                             if TempItemLedgerEntry.FindFirst then
//                                 Serials := TempItemLedgerEntry."Serial No.";
//                             if TempItemLedgerEntry.Next > 0 then
//                                 repeat
//                                     if TempItemLedgerEntry."Cannibalization Applied" then
//                                         DescriptiontoPrint := "Sales Invoice Line"."Description 2"
//                                     else
//                                         DescriptiontoPrint := "Sales Invoice Line".Description;
//                                     Serials := Serials + ',' + TempItemLedgerEntry."Serial No.";
//                                 until TempItemLedgerEntry.Next = 0;
//                             SalesInvLineExtTxt.Reset;
//                             SalesInvLineExtTxt.SetRange(SalesInvLineExtTxt."Document No.", "Sales Invoice Line"."Document No.");
//                             SalesInvLineExtTxt.SetRange(SalesInvLineExtTxt."Attached to Line No.", "Sales Invoice Line"."Line No.");
//                             if SalesInvLineExtTxt.FindFirst then
//                                 repeat
//                                     DescriptiontoPrint := DescriptiontoPrint + SalesInvLineExtTxt.Description;
//                                 until SalesInvLineExtTxt.Next = 0;
//                             if DescriptiontoPrint = '' then
//                                 DescriptiontoPrint := "Sales Invoice Line".Description;
//                             //IN0090.end
//                             PostedVchr.InitTextVariable;
//                             PostedVchr.FormatNoText(NumberText, TotalAmountInclVAT, "Sales Invoice Header"."Currency Code")
...
//                     {
//                         DataItemTableView = sorting(Number);
//                         column(SalesCommentLine_Comment; SalesCommentLine.Comment)
//                         {
//                         }
//                         column(SalesCommentLine_LineNo; SalesCommentLine."Line No.")
//                         {
//                         }
//                         trigger OnPreDataItem();
//                         begin
...
//                             SalesCommentLine.SetRange(SalesCommentLine."Document Line No.", 0);
//                             SetRange(Total2.Number, 1, SalesCommentLine.Count);
//                         end;

//                         trigger OnAfterGetRecord();
//                         begin
//                             if Total2.Number = 1 then
...
//             begin
//                 if "Bill to Customer State" <> 'JK' then begin
//                     RptName := 'Retail Invoice';
//                     RptBoolean := true;
//                 end;
//                 if "Bill to Customer State" = 'JK' then begin
//                     RptName := '';
...
//                 BankAccount.Get(SalesSetup."Bank Account for Receivables");
//                 BankAccNo := BankAccount."Bank Account No.";
//                 BankName := BankAccount.Name;
//                 SwiftCode := BankAccount."SWIFT Code";
//                 DetailedTaxEntry.SetRange(DetailedTaxEntry."Transaction Type", DetailedTaxEntry."transaction type"::Sale);
//                 DetailedTaxEntry.SetRange(DetailedTaxEntry."Document Type", DetailedTaxEntry."document type"::Invoice);
//                 DetailedTaxEntry.SetRange(DetailedTaxEntry."Document No.", "No.");
//                 if DetailedTaxEntry.FindFirst then
//                     TaxType := Format(DetailedTaxEntry."Tax Type")
//                 else
//                     TaxType := 'Tax';
//                 /*
...
//                     FormatAddr.Location(CompanyAddr, ShippingLocation);
//                     CompanyAddr[1] := CompanyInfo.Name;
//                 end else
//                     FormatAddr.Company(CompanyAddr, CompanyInfo);
//                 if Stte.Get(ShippingLocation."State Code") then;
...
//                     Clear(Cust);
//                 if (DetailedTaxEntry."Tax Type" = DetailedTaxEntry."tax type"::VAT) and (Cust."T.I.N. No." <> '') then
//                     InvoiceTitle := 'Tax Invoice'
//                 else
//                     if (DetailedTaxEntry."Tax Type" = DetailedTaxEntry."tax type"::VAT) and (Cust."T.I.N. No." = '') then
//                         InvoiceTitle := 'Retail Invoice'
//                     else
//                         if (DetailedTaxEntry."Tax Type" = DetailedTaxEntry."tax type"::CST) then
//                             InvoiceTitle := 'Retail Invoice'
//                         else
//                             if "Sales Invoice Header"."Location Code" = 'JK-VAT' then
//                                 InvoiceTitle := 'Tax Invoice'
//                             else
//                                 InvoiceTitle := 'Service Invoice';
//                 //IF "Sales Invoice Header"."Service Invoice" THEN BEGIN
//                 // InvoiceTitle := 'Service Invoice';
//                 //END ELSE BEGIN
//                 //if
//                 //  IF (Cust."T.I.N. No." <> '')  AND ("Form Code" = '' ) THEN
//                 //   InvoiceTitle := 'Tax Invoice'
//                 //ELSE
//                 // InvoiceTitle := 'Retail Invoice';
//                 //END;
...
//         DetailGSTLedEntry: Record "Detailed GST Ledger Entry";
...
//         LineDiscountCaptionLbl: label 'Discount Amount';
//         PostedShipmentDateCaptionLbl: label 'Posted Shipment Date';
//         SubtotalCaptionLbl: label 'Subtotal';
//         ExciseAmountCaptionLbl: label 'Excise Amount';
//         TaxAmountCaptionLbl: label '%1 Amount';
//         ServiceTaxAmountCaptionLbl: label 'Service Tax Amount';
//         ChargesAmountCaptionLbl: label 'SurCharge Amount';
...
//         companylog: Record "Company Information";
...
//         Item: Record Item;
//         ItemNo: Code[20];
//         SalesInvLineExtTxt: Record "Sales Invoice Line";
//         RptName: Text;
//         RptBoolean: Boolean;
