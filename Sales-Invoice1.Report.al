// Report 50040 "Sales - Invoice1"
// {
//     Caption = 'Sales - Invoice';
//     Permissions = TableData "Sales Shipment Buffer" = rimd;
//     PreviewMode = PrintLayout;
//     RDLCLayout = './Layouts/Sales-Invoice1.rdlc';
//     DefaultLayout = RDLC;
...
//                             AutoFormatType = 1;
//                         }
//                         column(AmtInclVAT_SalesInvLine; "Sales Invoice Line"."Amount To Customer")
//                         {
//                             AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
//                             AutoFormatType = 1;
//                         }
...
//                             AutoFormatType = 1;
//                         }
//                         column(TaxAmount_SalesInvLine; "Sales Invoice Line"."Tax Amount")
//                         {
//                             AutoFormatExpression = "Sales Invoice Line".GetCurrencyCode;
//                             AutoFormatType = 1;
//                         }
...
//                             InvoiceTitle := 'Retail Invoice'
//                         else
//                             if "Sales Invoice Header"."Location Code" = 'J&K-VAT' then
//                                 InvoiceTitle := 'Tax Invoice'
//                             else
