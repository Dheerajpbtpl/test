// Report 50031 "Punjab Purchase vat-19"
// {
//     UsageCategory = Lists;
//     RDLCLayout = './Layouts/PunjabPurchasevat-19.rdlc';
//     DefaultLayout = RDLC;
...
//         {
//             DataItemTableView = where("Source Type" = filter(Vendor), "Tax Type" = filter(CST), "Location Code" = filter('*LDH*'));
...
//             {
//             }
//             column(ExternalDocumentNo_DetailedTaxEntry; "Detailed Tax Entry"."External Document No.")
//             {
//             }
...
//                     if "Detailed Tax Entry"."Tax Type" = "Detailed Tax Entry"."tax type"::CST then begin
//                         TaxAmtC := "Detailed Tax Entry"."Tax Base Amount";
//                         TaxAmt1 := "Detailed Tax Entry"."Tax Amount";
//                         TAxAmtC1 := TaxAmtC + TaxAmt1;
//                         //message(format(TAxAmtC1));
//                     end;
//                     /*End
//                     else
...
//         I = 'Value of Goods (Rs.)*';
//         J = 'Value of Freight';
//         K = 'Entry Tax paid if any';
//         L = 'Name of Transporter';
//         M = 'GR/RR etc.Details';
//         N = 'Number';
//         O = 'Date (dd/mm/yyyy)';
//         P = 'Nature of Transaction(In case of Discount / Purchase Return)*';
//     }
